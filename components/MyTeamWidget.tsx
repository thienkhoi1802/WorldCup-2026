...
const MyTeamWidget: React.FC<MyTeamWidgetProps> = ({ onMatchClick, onTeamClick }) => {
  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 mb-12">
        {/* Main Container - Removed overflow-hidden to allow dropdown to show */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 h-[460px] flex flex-col transition-all duration-300 relative"> 
        
        {/* HEADER: TITLE + TABS */}
        <div className="shrink-0 bg-white border-b border-gray-200 rounded-t-xl z-20 relative">
             {/* Title Row */}
        ...
        <div className="flex-1 min-h-0 relative z-10">
            {isAddingMode || showEmptyState ? (
                // --- INLINED ADD TEAM INTERFACE ---
                <div className="h-full flex flex-col bg-white relative rounded-b-xl">
                    {/* Background Decor - Isolated in absolute container with overflow hidden */}
                    <div className="absolute inset-0 overflow-hidden rounded-b-xl pointer-events-none z-0">
                         <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#9f224e]/20 to-transparent"></div>
                         <div className="absolute -top-20 -right-20 w-56 h-56 bg-gray-50 rounded-full blur-3xl opacity-60"></div>
                         <div className="absolute -bottom-20 -left-20 w-56 h-56 bg-[#9f224e]/5 rounded-full blur-3xl"></div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 z-10 relative">
                        ...
                        <div className="w-full max-w-lg relative z-20" ref={searchContainerRef}>
                            <div className="relative group">
                                ...
                                {/* Search Dropdown - Opens DOWNWARDS */}
                                {isSearchFocused && (
                ...
                <div className="flex flex-col md:flex-row h-full overflow-hidden rounded-b-xl">
                    ...
                    {/* RIGHT: NEXT MATCH SPOTLIGHT (Visual Upgrade - Compact Layout) */}
                    <div className="w-full md:w-[360px] bg-gray-50 flex flex-col relative shrink-0">
                         ...
                         {/* Match Content - Tighter Padding to Fit Height */}
                         <div className="flex-1 p-4 flex flex-col justify-between relative overflow-hidden">
                             ...
                             {/* Teams Row */}
                             <div className="flex items-center justify-between mb-2 relative z-10 mt-1">
                                 {/* Home */}
                                 <div 
                             ...
                             {/* Time Ticket */}
                             <div className="bg-white border border-gray-200 rounded-xl py-3 px-4 shadow-sm mb-3 text-center relative group cursor-pointer hover:border-[#d8a709] transition-colors">
                             ...
                             <div className="mt-auto text-center">
                                 <div className="flex items-center justify-center gap-1 text-[10px] font-bold text-gray-400 uppercase mb-2">
                                     <MapPin className="w-3 h-3" /> {nextMatch.stadium}
                                 </div>
                                 <button 
                                    onClick={() => onMatchClick && onMatchClick(nextMatch!)}
                                    className="w-full bg-[#d8a709] hover:bg-[#c49608] text-white text-xs font-black uppercase py-2.5 rounded-lg shadow-sm hover:shadow-md active:scale-95 transition-all flex items-center justify-center gap-2"
                                 >
